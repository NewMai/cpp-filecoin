 ...
 * @then All operations must be completed successfully
 */
...
/**
 * @given CID of the block, which doesn't exists in the BlockService
 * @when Trying to get not-existence block from BlockService
