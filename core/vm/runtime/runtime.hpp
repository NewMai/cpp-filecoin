...
namespace fc::vm::runtime {
  ...
  class Runtime {
   public:
    ...
    // whether successful.
    virtual outcome::result<IpldObject> getIpld(ContentIdentifier cid) = 0;

    // Serializes and stores an object, returning its CID.
    virtual ContentIdentifier putIpld(IpldObject object) = 0;
  };
